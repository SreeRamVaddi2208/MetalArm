...
The database URL comes from app.core.config (environment variables), never
from alembic.ini - that keeps credentials out of version control and keeps
migrations pointed at the same database the app uses.
"""
